<properties
    pageTitle="À l’aide du connecteur de la boîte de dépôt dans les applications de logique | Service d’application Microsoft Azure"
    description="Comment créer et configurer l’application connecteur d’échange ou d’API et l’utiliser dans une logique d’application dans le Service d’application Azure"
    authors="msftman"
    manager="erikre"
    editor=""
    services="logic-apps"
...
# <a name="weve-improved-the-dropbox-connector"></a>Nous avons amélioré le connecteur d’échange 
