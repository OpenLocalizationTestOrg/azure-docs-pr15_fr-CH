<properties
   pageTitle="À l’aide du connecteur de Twilio dans les applications de logique | Service d’application Microsoft Azure"
   description="Comment créer et configurer l’application Connecteur de Twilio ou d’API et l’utiliser dans une logique d’application dans le Service d’application Azure"
   services="logic-apps"
...
# <a name="weve-improved-the-twilio-connector"></a>Nous avons amélioré le connecteur Twilio 
