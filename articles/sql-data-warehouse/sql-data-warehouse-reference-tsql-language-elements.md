<properties
   pageTitle="Éléments du langage Transact-SQL de magasin de données SQL | Microsoft Azure"
   description="Liste de liens vers le contenu de référence pour les éléments du langage Transact-SQL utilisée pour l’entrepôt de données SQL."
...
- [règles d’affectation de noms d’objet](https://msdn.microsoft.com/library/ms175874.aspx)
...
- [Solution de propriété d’identité](https://msdn.microsoft.com/library/ms186775.aspx)
- [IMPRIMER](https://msdn.microsoft.com/library/ms176047.aspx)
- [UTILISATION](https://msdn.microsoft.com/library/ms188366.aspx)

## <a name="batches-control-of-flow-and-variables"></a>Variables, contrôle de flux et les batchs

- [BEGIN... FIN](https://msdn.microsoft.com/library/ms190487.aspx)
...
## <a name="wildcard-characters-to-match"></a>Caractères génériques à faire correspondre
- [= (Égal)](https://msdn.microsoft.com/library/ms175118.aspx)
- [> (Supérieur à)](https://msdn.microsoft.com/library/ms178590.aspx)
- [< (Inférieur à)](https://msdn.microsoft.com/library/ms179873.aspx)
- [> = (great ou égal à)](https://msdn.microsoft.com/library/ms181567.aspx)
...
- [DANS](https://msdn.microsoft.com/library/ms177682.aspx)
- [IS [NOT] NULL](https://msdn.microsoft.com/library/ms188795.aspx)
- [COMME](https://msdn.microsoft.com/library/ms179859.aspx)
...
- [& (AND au niveau du bit)](https://msdn.microsoft.com/library/ms174965.aspx)
- [| (OR au niveau du bit)](https://msdn.microsoft.com/library/ms186714.aspx)
- [^ (OR exclusif)](https://msdn.microsoft.com/library/ms190277.aspx)
- [~ (NOT au niveau du bit)](https://msdn.microsoft.com/library/ms173468.aspx)
- [^ = (Exclusif au niveau du bit ou égal à)](https://msdn.microsoft.com/library/cc627413.aspx)
- [| = (Opérateur de bits OR est égal à)](https://msdn.microsoft.com/library/cc627409.aspx)
- [& = (opérateur de bits AND égal)](https://msdn.microsoft.com/library/cc627427.aspx)
...
- [CAS](https://msdn.microsoft.com/library/ms181765.aspx)
...
- [LA FONCTION ISDATE](https://msdn.microsoft.com/library/ms187347.aspx)
- [ISNULL](https://msdn.microsoft.com/library/ms184325.aspx)
- [LA FONCTION ISNUMERIC](https://msdn.microsoft.com/library/ms186272.aspx)
- [RETARD](https://msdn.microsoft.com/library/hh231256.aspx)
- [LAST_VALUE](https://msdn.microsoft.com/library/hh231517.aspx)
- [PROSPECT](https://msdn.microsoft.com/library/hh213125.aspx)
...
- [Fonctions scalaires de ODBCS](https://msdn.microsoft.com/library/bb630290.aspx)
- [SUR la clause](https://msdn.microsoft.com/library/ms189461.aspx)
- [PARSENAME](https://msdn.microsoft.com/library/ms188006.aspx)
- [FONCTION PATINDEX](https://msdn.microsoft.com/library/ms188395.aspx)
...
- [ALIMENTATION](https://msdn.microsoft.com/library/ms174276.aspx)
...
- [ARRONDIR](https://msdn.microsoft.com/library/ms175003.aspx)
...
- [SÉLECTIONS](https://msdn.microsoft.com/library/ms188043.aspx)
...
## <a name="set-statements"></a>JEU d’instructions
