<properties
    ...
    description="Cette rubrique décrit comment injecter des données personnalisées dans une machine virtuelle Azure lorsque l’instance est créée et la façon de localiser les données personnalisées sous Windows ou Linux."
