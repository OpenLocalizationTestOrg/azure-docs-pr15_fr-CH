<properties
    pageTitle="Windows les instructions Machines virtuelles | Microsoft Azure"
    description="En savoir plus sur les instructions de conception et d’implémentation clées pour le déploiement de machines virtuelles windows dans Azure"
    documentationCenter=""
...
- Créer vos ordinateurs virtuels à l’aide de PowerShell Azure, web portail, ou avec les modèles du Gestionnaire de ressources.
