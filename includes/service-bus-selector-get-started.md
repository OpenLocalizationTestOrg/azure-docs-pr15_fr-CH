> [AZURE. LISTE de la sélection (expéditeur | Récepteur)]
...
- [(C# | Tempête de Apache)](../articles/event-hubs/event-hubs-csharp-storm-getstarted.md)
...
- [(Java | Tempête de Apache)](../articles/event-hubs/event-hubs-java-storm-getstarted.md)
- [(C | C#)](../articles/event-hubs/event-hubs-c-ephcs-getstarted.md)
- [(C | Java)](../articles/event-hubs/event-hubs-c-ephjava-getstarted.md)
- [(C | Tempête de Apache)](../articles/event-hubs/event-hubs-c-storm-getstarted.md)